...
def graph_components_decode(
    ...
    *,
    ...
    # Fallback: if nothing was accepted but candidate components exist, accept the most probable one (lowest cross similarity)
    if accept.sum() == 0 and len(components) > 0:
        best_c = None
        min_cross = np.inf
