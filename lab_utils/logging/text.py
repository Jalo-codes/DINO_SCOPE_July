...
def log_metric_row(
    ...
    **fields,
    ...
    ``tag`` is one of the allowed log tags (e.g. ``'[eval]'``).
    ``prefix`` is an optional inline label between the tag and the fields
    (e.g. a split name or bucket label).
    ...
    Example::
        ...
        log_metric_row('[eval]', prefix='imd_val',
                       f1_med=0.7748, iou_med=0.6324, n=130)
        # -> [eval] imd_val f1_med=0.7748 iou_med=0.6324 n=130
    """
